...
var AllTeamsComponent = (function () {
    function AllTeamsComponent(appRestService) {
        this.appRestService = appRestService;
    }
    AllTeamsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appRestService.getAllTeams()
            .subscribe(function (team) { return _this.teams = team; }, function (error) { return _this.errorMessage = error; });
    };
...
//# sourceMappingURL=nav.teams.js.map
